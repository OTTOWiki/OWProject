 ...
 */
export const TOUCH_SENSITIVITY = 1.2;
...
· Nomiss 无伤模式：被弹（决死窗口未救回）不扣残机、不 Game Over，自动重开当前章节——BGM 回到进章位置、系统异常还原为本章开头那次、资源保留。进度自动持久化，重进从进度续章；仅在暂停菜单手动结算或通关结局自动结算；全程不录制录像、不入排行榜。
