...
· Unstable Machine：道中章节附加随机系统异常（攻击/分数加减、迷雾、Bomb 禁用或双倍消耗等）。负面效果不实时加分，仅在章节 NMNB（无Miss无Bomb）结算时给予补偿倍率；正面不加惩罚。后三面（A/B 线 4–6 面）一般叠加 2–3 个效果。
...
即便如此，组织却急转直下，几乎无人问津。饮泉思源与誓约沙玛作为核心人物，认定答案一定在门构皮蒂娅，或在「善雅乡」。她们决定亲自去一探究竟。`,
  ...
  {
    title: '六、关卡与路线',
    body: `· 第 1 面：维基外围 · 零散草稿 — Boss「爱丽丝」
· 第 2 面：编辑日常 · 审核冲突 — Boss「Icebin」
· 第 3 面：分歧的十字路口 — Boss「大宗关不是・互然雏」
· 倾向结算：A/B 倾向足够则进入对应线；否则由「全域巡查姬・404」拦截，胜后可手选路线。

A 线（门构皮蒂娅方向）
· A4 门百梁 → A5 主角组间冲突 → A6 一美个

B 线（善雅乡方向）
· B4 赌人时尚 → B5 棍电噢哆 → B6 拉斯特神炫`,
  },
  {
    title: '七、自机',
