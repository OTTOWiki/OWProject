...
export const chapters = [
  { id: 57, name: 'A6-1 乐园入口', stage: 'A6', stageKey: 'A6', kind: 'mid',
    music: 'a6_mid', bg: 'a6_mid', duration: 24, build: (g) => chapter_a6_mid_1(g) },
  ...
  { id: 59, name: 'A6-3 甜腻迷雾', stage: 'A6', stageKey: 'A6', kind: 'mid',
    music: 'a6_mid', bg: 'a6_mid', duration: 24, build: (g) => chapter_a6_mid_3(g) },
  { id: 60, name: 'A6-4 虚假善意', stage: 'A6', stageKey: 'A6', kind: 'mid',
    music: 'a6_mid', bg: 'a6_mid', duration: 26, build: (g) => chapter_a6_mid_4(g) },
  ...
  { id: 62, name: 'A6-6 甜蜜陷阱', stage: 'A6', stageKey: 'A6', kind: 'mid',
    music: 'a6_mid', bg: 'a6_mid', duration: 26, build: (g) => chapter_a6_mid_5(g) },
  { id: 63, name: 'A6-7 乐园暗流', stage: 'A6', stageKey: 'A6', kind: 'mid',
    music: 'a6_mid', bg: 'a6_mid', duration: 28, build: (g) => chapter_a6_mid_6(g) },
  { id: 64, name: 'A6-8 剧情裂痕', stage: 'A6', stageKey: 'A6', kind: 'mid',
    music: 'a6_mid', bg: 'a6_mid', duration: 28, build: (g) => chapter_a6_mid_7(g) },
  { id: 65, name: 'A6-9 乐园崩坏前兆', stage: 'A6', stageKey: 'A6', kind: 'mid',
    music: 'a6_mid', bg: 'a6_mid', duration: 30, build: (g) => chapter_a6_mid_8(g) },
  { id: 66, name: 'A6-10 真相浮现', stage: 'A6', stageKey: 'A6', kind: 'mid',
    music: 'a6_mid', bg: 'a6_mid', duration: 28, build: (g) => chapter_a6_mid_9(g) },
  { id: 67, name: 'A6-11 最终层切入', stage: 'A6', stageKey: 'A6', kind: 'mid',
    music: 'a6_mid', bg: 'a6_mid', duration: 30, build: (g) => chapter_a6_mid_10(g) },
