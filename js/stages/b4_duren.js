...
export const chapters = [
  { id: 77, name: 'B4-1 善雅乡入口', stage: 'B4', stageKey: 'B4', kind: 'mid',
    music: 'b4_mid', bg: 'b4_mid', duration: 24, build: (g) => chapter_b4_mid_1(g) },
  ...
  { id: 79, name: 'B4-3 哲学信徒', stage: 'B4', stageKey: 'B4', kind: 'mid',
    music: 'b4_mid', bg: 'b4_mid', duration: 24, build: (g) => chapter_b4_mid_3(g) },
  ...
  { id: 81, name: 'B4-5 哲学洗脑', stage: 'B4', stageKey: 'B4', kind: 'mid',
    music: 'b4_mid', bg: 'b4_mid', duration: 26, build: (g) => chapter_b4_mid_4(g) },
  { id: 82, name: 'B4-6 狂人语录', stage: 'B4', stageKey: 'B4', kind: 'mid',
    music: 'b4_mid', bg: 'b4_mid', duration: 28, build: (g) => chapter_b4_mid_5(g) },
  { id: 83, name: 'B4-7 创世独轮', stage: 'B4', stageKey: 'B4', kind: 'mid',
    music: 'b4_mid', bg: 'b4_mid', duration: 28, build: (g) => chapter_b4_mid_6(g) },
