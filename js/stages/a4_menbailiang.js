...
export const chapters = [
  { id: 25, name: 'A4-1 方尖碑阵列入口', stage: 'A4', stageKey: 'A4', kind: 'mid',
    music: 'a4_mid', bg: 'a4_mid', duration: 26, build: (g) => chapter_a4_mid_1(g) },
  ...
  { id: 27, name: 'A4-3 特惠海报弹幕', stage: 'A4', stageKey: 'A4', kind: 'mid',
    music: 'a4_mid', bg: 'a4_mid', duration: 24, build: (g) => chapter_a4_mid_3(g) },
  ...
  { id: 29, name: 'A4-5 限时通道', stage: 'A4', stageKey: 'A4', kind: 'mid',
    music: 'a4_mid', bg: 'a4_mid', duration: 26, build: (g) => chapter_a4_mid_4(g) },
  { id: 30, name: 'A4-6 捆绑销售压力', stage: 'A4', stageKey: 'A4', kind: 'mid',
    music: 'a4_mid', bg: 'a4_mid', duration: 28, build: (g) => chapter_a4_mid_5(g) },
  { id: 31, name: 'A4-7 最终推销线', stage: 'A4', stageKey: 'A4', kind: 'mid',
    music: 'a4_mid', bg: 'a4_mid', duration: 28, build: (g) => chapter_a4_mid_6(g) },
