...
export const chapters = [
  { id: 92, name: 'B5-1 街角暗巷', stage: 'B5', stageKey: 'B5', kind: 'mid',
    unstable: true, music: 'b5_mid', bg: 'b5_mid', duration: 24, build: (g) => chapter_b5_mid_1(g) },
  ...
  { id: 94, name: 'B5-3 素质质问', stage: 'B5', stageKey: 'B5', kind: 'mid',
    unstable: true, music: 'b5_mid', bg: 'b5_mid', duration: 24, build: (g) => chapter_b5_mid_3(g) },
  { id: 95, name: 'B5-4 世界第一宣言', stage: 'B5', stageKey: 'B5', kind: 'mid',
    unstable: true, music: 'b5_mid', bg: 'b5_mid', duration: 26, build: (g) => chapter_b5_mid_4(g) },
  ...
  { id: 97, name: 'B5-6 推退拉锯', stage: 'B5', stageKey: 'B5', kind: 'mid',
    unstable: true, music: 'b5_mid', bg: 'b5_mid', duration: 26, build: (g) => chapter_b5_mid_5(g) },
  { id: 98, name: 'B5-7 嘴硬交锋', stage: 'B5', stageKey: 'B5', kind: 'mid',
    unstable: true, music: 'b5_mid', bg: 'b5_mid', duration: 28, build: (g) => chapter_b5_mid_6(g) },
  { id: 99, name: 'B5-8 甩锅预演', stage: 'B5', stageKey: 'B5', kind: 'mid',
    unstable: true, music: 'b5_mid', bg: 'b5_mid', duration: 28, build: (g) => chapter_b5_mid_7(g) },
  { id: 100, name: 'B5-9 这波怎么说', stage: 'B5', stageKey: 'B5', kind: 'mid',
    unstable: true, music: 'b5_mid', bg: 'b5_mid', duration: 28, build: (g) => chapter_b5_mid_8(g) },
