...
export const chapters = [
  { id: 40, name: 'A5-1 渐行渐远', stage: 'A5', stageKey: 'A5', kind: 'mid',
    unstable: true, music: 'a5_mid', bg: 'a5_mid', duration: 24, build: (g) => chapter_a5_mid_1(g) },
  ...
  { id: 42, name: 'A5-3 署名争议', stage: 'A5', stageKey: 'A5', kind: 'mid',
    unstable: true, music: 'a5_mid', bg: 'a5_mid', duration: 26, build: (g) => chapter_a5_mid_3(g) },
  { id: 43, name: 'A5-4 编辑权限争夺', stage: 'A5', stageKey: 'A5', kind: 'mid',
    unstable: true, music: 'a5_mid', bg: 'a5_mid', duration: 28, build: (g) => chapter_a5_mid_4(g) },
  ...
  { id: 45, name: 'A5-6 数据撕裂', stage: 'A5', stageKey: 'A5', kind: 'mid',
    unstable: true, music: 'a5_mid', bg: 'a5_mid', duration: 28, build: (g) => chapter_a5_mid_5(g) },
  { id: 46, name: 'A5-7 剑拔弩张', stage: 'A5', stageKey: 'A5', kind: 'mid',
    unstable: true, music: 'a5_mid', bg: 'a5_mid', duration: 28, build: (g) => chapter_a5_mid_6(g) },
  { id: 47, name: 'A5-8 世界观碰撞', stage: 'A5', stageKey: 'A5', kind: 'mid',
    unstable: true, music: 'a5_mid', bg: 'a5_mid', duration: 28, build: (g) => chapter_a5_mid_7(g) },
  { id: 48, name: 'A5-9 最终对峙', stage: 'A5', stageKey: 'A5', kind: 'mid',
    unstable: true, music: 'a5_mid', bg: 'a5_mid', duration: 28, build: (g) => chapter_a5_mid_8(g) },
