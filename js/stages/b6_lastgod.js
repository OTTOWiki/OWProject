...
export const chapters = [
  { id: 109, name: 'B6-1 迷雾边境', stage: 'B6', stageKey: 'B6', kind: 'mid',
    music: 'b6_mid', bg: 'b6_mid', duration: 26, build: (g) => chapter_b6_mid_1(g) },
  ...
  { id: 111, name: 'B6-3 炫妈气息', stage: 'B6', stageKey: 'B6', kind: 'mid',
    music: 'b6_mid', bg: 'b6_mid', duration: 26, build: (g) => chapter_b6_mid_3(g) },
  { id: 112, name: 'B6-4 虾油迷雾', stage: 'B6', stageKey: 'B6', kind: 'mid',
    music: 'b6_mid', bg: 'b6_mid', duration: 26, build: (g) => chapter_b6_mid_4(g) },
  ...
  { id: 114, name: 'B6-6 宝瓶守护', stage: 'B6', stageKey: 'B6', kind: 'mid',
    music: 'b6_mid', bg: 'b6_mid', duration: 28, build: (g) => chapter_b6_mid_5(g) },
  { id: 115, name: 'B6-7 王座之道', stage: 'B6', stageKey: 'B6', kind: 'mid',
    music: 'b6_mid', bg: 'b6_mid', duration: 28, build: (g) => chapter_b6_mid_6(g) },
  { id: 116, name: 'B6-8 防空洞陷阱', stage: 'B6', stageKey: 'B6', kind: 'mid',
    music: 'b6_mid', bg: 'b6_mid', duration: 28, build: (g) => chapter_b6_mid_7(g) },
  { id: 117, name: 'B6-9 风油精屏障', stage: 'B6', stageKey: 'B6', kind: 'mid',
    music: 'b6_mid', bg: 'b6_mid', duration: 30, build: (g) => chapter_b6_mid_8(g) },
  { id: 118, name: 'B6-10 宝瓶封印解除', stage: 'B6', stageKey: 'B6', kind: 'mid',
    music: 'b6_mid', bg: 'b6_mid', duration: 28, build: (g) => chapter_b6_mid_9(g) },
  { id: 119, name: 'B6-11 王座前震荡', stage: 'B6', stageKey: 'B6', kind: 'mid',
    music: 'b6_mid', bg: 'b6_mid', duration: 32, build: (g) => chapter_b6_mid_10(g) },
