...
export const chapters = [
  { id: 109, name: 'B6-1 迷雾边境', stage: 'B6', stageKey: 'B6', kind: 'mid',
    unstable: true, music: 'b6_mid', bg: 'b6_mid', duration: 26, build: (g) => chapter_b6_mid_1(g) },
  { id: 110, name: 'B6-2 Unstable 防御塔阵列', stage: 'B6', stageKey: 'B6', kind: 'mid',
    unstable: true, music: 'b6_mid', bg: 'b6_mid', duration: 28, build: (g) => chapter_b6_mid_2(g) },
  { id: 111, name: 'B6-3 炫妈气息', stage: 'B6', stageKey: 'B6', kind: 'mid',
    unstable: true, music: 'b6_mid', bg: 'b6_mid', duration: 26, build: (g) => chapter_b6_mid_3(g) },
  { id: 112, name: 'B6-4 虾油迷雾', stage: 'B6', stageKey: 'B6', kind: 'mid',
    unstable: true, music: 'b6_mid', bg: 'b6_mid', duration: 26, build: (g) => chapter_b6_mid_4(g) },
  { id: 113, name: 'B6-5 神炫祭司', stage: 'B6', stageKey: 'B6', kind: 'midboss',
    music: 'b6_mid', bg: 'b6_mid', duration: 36, build: (g) => chapter_b6_midboss(g) },
  { id: 114, name: 'B6-6 宝瓶守护', stage: 'B6', stageKey: 'B6', kind: 'mid',
    unstable: true, music: 'b6_mid', bg: 'b6_mid', duration: 28, build: (g) => chapter_b6_mid_5(g) },
  { id: 115, name: 'B6-7 王座之道', stage: 'B6', stageKey: 'B6', kind: 'mid',
    unstable: true, music: 'b6_mid', bg: 'b6_mid', duration: 28, build: (g) => chapter_b6_mid_6(g) },
  { id: 116, name: 'B6-8 防空洞陷阱', stage: 'B6', stageKey: 'B6', kind: 'mid',
    unstable: true, music: 'b6_mid', bg: 'b6_mid', duration: 28, build: (g) => chapter_b6_mid_7(g) },
  { id: 117, name: 'B6-9 风油精屏障', stage: 'B6', stageKey: 'B6', kind: 'mid',
    unstable: true, music: 'b6_mid', bg: 'b6_mid', duration: 30, build: (g) => chapter_b6_mid_8(g) },
  { id: 118, name: 'B6-10 宝瓶封印解除', stage: 'B6', stageKey: 'B6', kind: 'mid',
    unstable: true, music: 'b6_mid', bg: 'b6_mid', duration: 28, build: (g) => chapter_b6_mid_9(g) },
  { id: 119, name: 'B6-11 王座前震荡', stage: 'B6', stageKey: 'B6', kind: 'mid',
    unstable: true, music: 'b6_mid', bg: 'b6_mid', duration: 32, build: (g) => chapter_b6_mid_10(g) },
  { id: 120, name: '拉斯特神炫「炫妈迷雾·王座审判」', stage: 'B6', stageKey: 'B6', kind: 'boss',
    music: 'b6_boss', bg: 'b6_boss', dialogue: 'b6', letter: '炫妈迷雾 · 王座审判', letterTime: 45,
    build: (g) => chapter_lastgod_1(g) },
  { id: 121, name: '拉斯特神炫「炫妈迷雾·虾油侵蚀」', stage: 'B6', stageKey: 'B6', kind: 'boss',
    music: 'b6_boss', bg: 'b6_boss', letter: '炫妈涂抹 · 虾油侵蚀', letterTime: 44,
    build: (g) => chapter_lastgod_2(g) },
  { id: 122, name: '拉斯特神炫「炫妈迷雾·宝瓶泄露」', stage: 'B6', stageKey: 'B6', kind: 'boss',
    music: 'b6_boss', bg: 'b6_boss', letter: '炫妈迷雾 · 宝瓶泄露', letterTime: 46,
    build: (g) => chapter_lastgod_3(g) },
  { id: 123, name: '拉斯特神炫「炫妈迷雾·味道扩散」', stage: 'B6', stageKey: 'B6', kind: 'boss',
    music: 'b6_boss', bg: 'b6_boss', letter: '炫妈迷雾 · 味道扩散', letterTime: 46,
    build: (g) => chapter_lastgod_4(g) },
  { id: 124, name: '拉斯特神炫「炫妈迷雾·神之轻蔑」', stage: 'B6', stageKey: 'B6', kind: 'boss',
    music: 'b6_boss', bg: 'b6_boss', letter: '炫妈迷雾 · 神之轻蔑', letterTime: 48,
    build: (g) => chapter_lastgod_5(g) },
  { id: 125, name: '拉斯特神炫「炫妈迷雾·雾中獠牙」', stage: 'B6', stageKey: 'B6', kind: 'boss',
    music: 'b6_boss', bg: 'b6_boss', letter: '炫妈迷雾 · 雾中獠牙', letterTime: 48,
    build: (g) => chapter_lastgod_6(g) },
  { id: 126, name: '拉斯特神炫「炫妈迷雾·王座崩塌」', stage: 'B6', stageKey: 'B6', kind: 'boss',
    music: 'b6_boss', bg: 'b6_boss', letter: '炫妈迷雾 · 王座崩塌', letterTime: 50,
    build: (g) => chapter_lastgod_7(g) },
  { id: 127, name: '拉斯特神炫「虾油风油精·绝对帝国」', stage: 'B6', stageKey: 'B6', kind: 'boss',
    music: 'b6_boss', bg: 'b6_boss', dialogue: 'b6_last', letter: '虾油风油精 · 绝对帝国', letterTime: 55,
    build: (g) => chapter_lastgod_8(g) },
  { id: 128, name: '拉斯特神炫「虾油风油精·炫妈归天」', stage: 'B6', stageKey: 'B6', kind: 'boss',
    music: 'b6_boss', bg: 'b6_boss', letter: '虾油风油精 · 炫妈归天', letterTime: 60,
    ending: 'B',
    build: (g) => chapter_lastgod_last(g) },
];
