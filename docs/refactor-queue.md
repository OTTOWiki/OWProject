...
当前应执行：**T04 等手测**（含 Three 点材质警告修复）→ 通过后开 **T05**。
...
| 日期 | 任务 | 自动测试 | 手测 | 备注 |
|------|------|----------|------|------|
| 2026-07-18 | T01 | 17/17 通过 | 完成 | 删 `buildMidWave/Sides/Rain/Ring` |
| 2026-07-18 | Debug 模式 | 17/17 通过 | 完成 | `4e6bdde` |
| 2026-07-18 | T02 | 17/17 通过 | 完成 | `ce43d37` |
| 2026-07-18 | T03 | 17/17 通过 | 完成 | 删 `ex_p2`…`ex_p5`；`8875f78` |
| 2026-07-18 | T04 | 17/17 通过 | 待确认 | Back 单音 `cancel`；同提交 `8875f78` |
| 2026-07-18 | Three 警告 | — | 待确认 | `sizeAttenuation` 实修 `2c80a34` |
