...
当前应执行：下一可选项 **T13**（拆 entities 绘制）— 需你确认后开始。
...
| 日期 | 任务 | 自动测试 | 手测 | 备注 |
|------|------|----------|------|------|
| 2026-07-18 | T12a | 32/32 | 完成 | `dd2fcfb` |
| 2026-07-18 | T12b | 32/32 | 完成 | `92798fc` |
| 2026-07-18 | T12c | 32/32 | 完成 | `7579d12` |
| 2026-07-18 | 语法门 + 浏览器 load | 语法+32 | — | `check-syntax` + `cases-load` |
| 2026-07-18 | T12d | 语法+32 | 完成 | `gameCombat.js`；修模块内 `this`→`game` 卡死 |
