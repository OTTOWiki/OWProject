...
| 日期 | 任务 | 自动测试 | 手测 | 备注 |
|------|------|----------|------|------|
| 2026-07-18 | T01–T04 | 通过 | 完成 | 见上文提交 |
| 2026-07-18 | Debug 静默 | — | 待确认 | 启动不再 console 提示；`owDebug.help()` 仍可用 |
| 2026-07-18 | T05 | 21/21 通过 | 待确认 | stageSelect 对齐、对话键、letterTime、FPS clamp |
