...
当前应执行：**T12d**（抽出 combat / 收束 game.js）— 需你确认后开始。
...
| 2026-07-18 | T12c | 32/32 | 完成 | `chapterFlow.js`；game.js ~900 行；修多余 `}` 导致加载 0% |
| 2026-07-18 | 测试语法门 | — | — | `test/check-syntax.mjs` 并入 `npm test` |
